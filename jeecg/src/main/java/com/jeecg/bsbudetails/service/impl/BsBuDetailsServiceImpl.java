package com.jeecg.bsbudetails.service.impl;
...
@Service("bsBuDetailsService")
@Transactional
public class BsBuDetailsServiceImpl extends CommonServiceImpl implements BsBuDetailsServiceI {
